...
from app.utils.validators import validate_file_extension, validate_file_size, validate_query_text
...
async def upload_document(
    ...
    try:
        ...
        document_id = await document_service.process_document(file_content, file.filename)
